...
export function CarouselSection() {
  const row1 = carouselImages.slice(0, 4);
    ...
    <section className="bg-gradient-to-br from-ink via-ink-soft to-ink-deep py-10 sm:py-14 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto w-full overflow-hidden">
        ...
        <div className="flex flex-col items-center mt-10 sm:mt-12 px-4">
          <span className="bg-white/10 text-white font-extrabold px-5 sm:px-8 py-2.5 sm:py-3 rounded-full text-xs sm:text-sm tracking-wide text-center uppercase border border-white/25 shadow-sm text-balance">
            {copy.carousel.badge}
          </span>
        </div>
      </div>
